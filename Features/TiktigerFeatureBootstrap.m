...
+ (NSArray<NSString *> *)registerPriorityModulesIntoManager:(TiktigerModuleManager *)manager error:(NSError **)error {
    ...
    TiktigerDownloadModule *download = [[TiktigerDownloadModule alloc] initWithFeatureID:@"media.download" name:@"Download Module" version:@"1.1" configuration:@{@"schemaVersion": @1, @"mediaType": @"video", @"destination": @"files", @"queueLimit": @5} uiRepresentation:@{@"surface": @"Download Center", @"category": @"media"}];
