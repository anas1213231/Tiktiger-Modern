...
+ (NSArray<NSString *> *)registerPriorityModulesIntoManager:(TiktigerModuleManager *)manager error:(NSError **)error {
    ...
    NSArray *modules = @[secure, privacy, appearance, chat, diagnostics, health, download, preferences];
    ...
    for (NSString *featureID in @[@"platform.secure-configuration", @"privacy.center", @"appearance.engine", @"chat.center", @"diagnostics.center", @"health.monitor"]) {
