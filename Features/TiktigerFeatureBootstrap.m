...
+ (NSArray<NSString *> *)registerPriorityModulesIntoManager:(TiktigerModuleManager *)manager error:(NSError **)error {
    ...
    TiktigerSystemModule *system = [[TiktigerSystemModule alloc] initWithModuleManager:manager];
    ...
    NSArray *modules = @[secure, privacy, appearance, chat, profile, system, diagnostics, health, download, preferences];
    ...
    for (NSString *featureID in @[@"platform.secure-configuration", @"privacy.center", @"appearance.engine", @"chat.center", @"profile.center", @"system.center", @"diagnostics.center", @"health.monitor"]) {
